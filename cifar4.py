...
class DualSystemModule(nn.Module):
    def __init__(self, dim):
        super().__init__()
        self.fast_path = FastSlowLinear(dim, dim, fast_lr=0.015)
        self.slow_path = FastSlowLinear(dim, dim, fast_lr=0.003)
...
class OmniBrainFastSlow(nn.Module):
    def __init__(self):
        ...
        self.core = nn.Sequential(nn.Linear(256, 256), nn.ReLU(), nn.LayerNorm(256))
        # SIEMPRE usar fast/slow y conciencia en esta versión calibrada
