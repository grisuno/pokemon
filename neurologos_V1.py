...
class MiniUnconscious(nn.Module):
    def __init__(self):
        ...
        self.topo_bridge = nn.Linear(128*8*8, 512)  # Puente topológico
        
    def forward(self, x):
        return self.topo_bridge(self.stem(x))
...
class CIFARCaptions:
    def __init__(self):
        from torchvision import datasets, transforms  # Añade transforms
